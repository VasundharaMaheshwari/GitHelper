import { type GetAccountInfoApi, type Rpc, Address } from '@solana/kit';
/**
 ...
 */
export declare function amountToUiAmountForMintWithoutSimulation(rpc: Rpc<GetAccountInfoApi>, mint: Address, amount: bigint): Promise<string>;
/**
 ...
 * @return Raw amount
 */
export declare function uiAmountToAmountForMintWithoutSimulation(rpc: Rpc<GetAccountInfoApi>, mint: Address, uiAmount: string): Promise<bigint>;

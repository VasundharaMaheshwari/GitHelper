...
this.globalThis.solanaWeb3 = (function (exports) {
  ...
  function assertDigestCapabilityIsAvailable() {
    ...
    if (typeof globalThis.crypto === "undefined" || typeof ((_a = globalThis.crypto.subtle) == null ? undefined : _a.digest) !== "function") {
  ...
  async function assertKeyGenerationIsAvailable() {
    var _a;
    assertIsSecureContext();
    if (typeof globalThis.crypto === "undefined" || typeof ((_a = globalThis.crypto.subtle) == null ? undefined : _a.generateKey) !== "function") {
  ...
  function assertKeyExporterIsAvailable() {
    var _a;
    assertIsSecureContext();
    if (typeof globalThis.crypto === "undefined" || typeof ((_a = globalThis.crypto.subtle) == null ? undefined : _a.exportKey) !== "function") {
  ...
  function assertSigningCapabilityIsAvailable() {
    var _a;
    assertIsSecureContext();
    if (typeof globalThis.crypto === "undefined" || typeof ((_a = globalThis.crypto.subtle) == null ? undefined : _a.sign) !== "function") {
  ...
  function assertVerificationCapabilityIsAvailable() {
    var _a;
    assertIsSecureContext();
    if (typeof globalThis.crypto === "undefined" || typeof ((_a = globalThis.crypto.subtle) == null ? undefined : _a.verify) !== "function") {
  ...
  function isLittleEndian(config) {
    return (config == null ? undefined : config.endian) === 1 ? false : true;
  }
  ...
  function getArrayEncoder(item, config = {}) {
    ...
    const maxSize = (_b = computeArrayLikeCodecSize(size, getMaxSize(item))) != null ? _b : undefined;
    return createEncoder({
  ...
  function getTupleEncoder(items) {
    ...
    const maxSize = (_a = sumCodecSizes(items.map(getMaxSize))) != null ? _a : undefined;
    return createEncoder({
      ...fixedSize === null ? {
  ...
  function getStructEncoder(fields) {
    ...
    const maxSize = (_a = sumCodecSizes(fieldCodecs.map(getMaxSize))) != null ? _a : undefined;
    return createEncoder({
      ...fixedSize === null ? {
  ...
  function assertIsInstructionWithData(instruction) {
    ...
    if (instruction.data === undefined) {
      throw new SolanaError(SOLANA_ERROR__INSTRUCTION__EXPECTED_TO_HAVE_DATA, {
        accountAddresses: (_a = instruction.accounts) == null ? undefined : _a.map((a) => a.address),
        programAddress: instruction.programAddress
      });
    }
  }
  ...
  function isProgramError(error, transactionMessage, programAddress, code) {
    ...
    const instructionProgramAddress = (_a = transactionMessage.instructions[error.context.index]) == null ? undefined : _a.programAddress;
  ...
  function wrapIntegersInBigIntValueObject(json) {
    ...
    for (let ii = 0; ii < json.length; ii++) {
      ...
      if (!inQuote) {
        ...
        if (consumedNumber == null ? undefined : consumedNumber.length) {
  ...
  function consumeNumber(json, ii) {
    ...
    if (!((_a = json[ii]) == null ? undefined : _a.match(/[-\d]/))) {
      return null;
    }
  ...
  function createPendingRpcRequest({ transport }, plan) {
    return {
      async send(options) {
        return await plan.execute({ signal: options == null ? undefined : options.abortSignal, transport });
      }
    };
  }
    ...
    return new Proxy({}, {
      ...
      get(...args) {
        ...
        return function(...rawParams) {
          ...
          const request = (config == null ? undefined : config.requestTransformer) ? config == null ? undefined : config.requestTransformer(rawRequest) : rawRequest;
          return Object.freeze({
            execute: async ({ signal, transport }) => {
              const payload = createRpcMessage(request);
              const response = await transport({ payload, signal });
              if (!(config == null ? undefined : config.responseTransformer)) {
                return response;
              }
  ...
  function applyDefaultCommitment({
    ...
    if (
      // There's no config.
      paramInTargetPosition === undefined || // There is a config object.
  ...
  function getDefaultRequestTransformerForSolanaRpc(config) {
    const handleIntegerOverflow = config == null ? undefined : config.onIntegerOverflow;
    return (request) => {
      return pipe(
        request,
        ...
        getDefaultCommitmentRequestTransformer({
          defaultCommitment: config == null ? undefined : config.defaultCommitment,
  ...
  function getDefaultResponseTransformerForSolanaRpc(config) {
    return (response, request) => {
      ...
      const keyPaths = (config == null ? undefined : config.allowedNumericKeyPaths) && methodName ? config.allowedNumericKeyPaths[methodName] : undefined;
      return pipe(
        response,
    ...
    return {
      ...
      on(channelName, subscriber, options) {
        ...
        function handleUnsubscribe() {
          ...
          isActive = false;
          options == null ? undefined : options.signal.removeEventListener("abort", handleUnsubscribe);
          innerPublisherState.numSubscribers--;
        ...
        options == null ? undefined : options.signal.addEventListener("abort", handleUnsubscribe);
  ...
  function augmentSubscriberCountAndReturnNewCount(amount, channel, subscriptionId) {
    ...
    if ((subscriberCountBySubscriptionId == null ? undefined : subscriberCountBySubscriptionId[subscriptionId]) !== undefined) {
  ...
  function createWebSocketChannel({
    ...
    function handleClose(ev) {
      cleanupListeners();
      bufferDrainWatcher == null ? undefined : bufferDrainWatcher.onCancel();
      signal.removeEventListener("abort", handleAbort);
  ...
  function getChannelPoolingChannelCreator(createChannel, { maxSubscriptionsPerChannel, minChannels }) {
    ...
    function recomputeFreeChannelIndex() {
      ...
      pool.freeChannelIndex = (_a = mostFreeChannel == null ? undefined : mostFreeChannel.poolIndex) != null ? _a : -1;
    }
  ...
  function getCompiledTransactionMessageDecoder() {
    return transformDecoder(
      ...
      ({ addressTableLookups, ...restOfMessage }) => {
        if (restOfMessage.version === "legacy" || !(addressTableLookups == null ? undefined : addressTableLookups.length)) {
  ...
  function isAdvanceNonceAccountInstruction(instruction) {
    ...
    ((_a = instruction.accounts) == null ? undefined : _a.length) === 3 && // First account is nonce account address
  ...
  function setTransactionMessageFeePayer(feePayer, transactionMessage) {
    var _a;
    if ("feePayer" in transactionMessage && feePayer === ((_a = transactionMessage.feePayer) == null ? undefined : _a.address) && isAddressOnlyFeePayer(transactionMessage.feePayer)) {
  ...
  function convertInstruction(instruction, accountMetas) {
    var _a, _b;
    const programAddress = (_a = accountMetas[instruction.programAddressIndex]) == null ? undefined : _a.address;
    if (!programAddress) {
      throw new SolanaError(SOLANA_ERROR__TRANSACTION__FAILED_TO_DECOMPILE_INSTRUCTION_PROGRAM_ADDRESS_NOT_FOUND, {
        index: instruction.programAddressIndex
      });
    }
    const accounts = (_b = instruction.accountIndices) == null ? undefined : _b.map((accountIndex) => accountMetas[accountIndex]);
  ...
  function decompileTransactionMessage(compiledTransactionMessage, config) {
    ...
    const accountLookupMetas = "addressTableLookups" in compiledTransactionMessage && compiledTransactionMessage.addressTableLookups !== undefined && compiledTransactionMessage.addressTableLookups.length > 0 ? getAddressLookupMetas(
      ...
      (_a = config == null ? undefined : config.addressesByLookupTableAddress) != null ? _a : {}
    ) : [];
    ...
    const lifetimeConstraint = getLifetimeConstraint(
      ...
      firstInstruction,
      config == null ? undefined : config.lastValidBlockHeight
    );
    return pipe(
  ...
  async function signAndSendTransactionMessageWithSigners(transaction, config) {
    assertIsTransactionMessageWithSingleSendingSigner(transaction);
    const abortSignal = config == null ? undefined : config.abortSignal;
    const { partialSigners, modifyingSigners, sendingSigner } = categorizeTransactionSigners(
      deduplicateSigners(getSignersFromTransactionMessage(transaction).filter(isTransactionSigner))
    );
    abortSignal == null ? undefined : abortSignal.throwIfAborted();
  ...
  async function signModifyingAndPartialTransactionSigners(transactionMessage, modifyingSigners = [], partialSigners = [], config) {
    ...
    const modifiedTransaction = await modifyingSigners.reduce(
      async (transaction2, modifyingSigner) => {
        var _a2;
        (_a2 = config == null ? undefined : config.abortSignal) == null ? undefined : _a2.throwIfAborted();
        const [tx] = await modifyingSigner.modifyAndSignTransactions([await transaction2], config);
        return Object.freeze(tx);
      },
      Promise.resolve(transaction)
    );
    (_a = config == null ? undefined : config.abortSignal) == null ? undefined : _a.throwIfAborted();
  ...
  async function raceStrategies(signature2, config, getSpecificStrategiesForRace) {
    ...
    callerAbortSignal == null ? undefined : callerAbortSignal.throwIfAborted();
    const abortController = new o7();
  ...
  function getSendTransactionConfigWithAdjustedPreflightCommitment(commitment, config) {
    if (
      ...
      !(config == null ? undefined : config.preflightCommitment) && // The value of `commitment` is lower than the server default of `preflightCommitment`.
